...
tabPanel("Dispersion", 
         ...
         column(8, h4("Input air dispersion factors", style="margin-botom:0px; padding-bottom:0px;"), 
                p("If file is not uploaded, factors are estimated based on stack height and fenceline distance.", style="font-style: italic;"), 
                dataTableOutput("disp_table"), hr(), 
                p("Upload dispersion factors as an Excel file (.xlsx) or comma seperated text file (.csv).", style="margin-botom:-20px; padding-bottom:0px;"), 
                uiOutput("disp_up"), hr())
         ),
...
tabPanel("Emissions",
         ...
         tabPanel("Hourly emissions",
                br(),
                p("Enter maximum hourly emissions in lbs/hr."), 
                br(),
                fluidRow(column(10,dataTableOutput("hr_emissions_table"))),
                hr(), 
          ...
          tabPanel("Annual emissions",
                 br(),
                 p("Enter maximum annual emissions in tons/year."),
                 br(),
