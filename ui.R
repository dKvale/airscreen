...
tabPanel("Risks", 
  ...
  tags$i(class='fa fa-download'), 'Download template file'), id='upload_box'))
                      ...
                      tabPanel("Air toxics process",
                               fluidRow(column(12, tags$img(src="https://cloud.githubusercontent.com/assets/6283030/19670058/eafa1d92-9a29-11e6-87e1-9693f742549d.png", width="70%"))),
                               fluidRow(column(12, br(),
                                              HTML('<script src="https://gist.github.com/dKvale/72275dcbf789df4690be807821af16c0.js"></script>'))),
                      ...
                      tabPanel("Comments and Updates",
                               fluidRow(column(12, br(), hr())),
                               fluidRow(column(12,
                                               HTML('<script src="https://gist.github.com/dKvale/c8db3b20e5ae9071cd1b3bcf193d5633.js"></script>'))),
                               fluidRow(column(12, h3('Comments and Updates'), hr())),
                               fluidRow(column(8, p('View recent changes, provide comments, and contribute to this project at ', 
                                                    tags$a(href='https://github.com/dKvale/fair-screen', 'https://github.com/dKvale/fair-screen.')))))
         ),
br(), hr(),
